...
<head>
    ...
    <title><?php echo ucwords(str_replace('_',' ',$page)) ?> |chat MedApp</title>
...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-gradient" id="topNavBar">
        <div class="container">
           ...
           application d'echange avec les medecins
            </a>
            ...
            <?php if(isset($_SESSION['id'])): ?>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="./?page=profile">mon Profile</a></li>
                        <li><a class="dropdown-item" href="./Actions.php?a=logout">se deconnecter</a></li>
                    </ul>
                </div>
            <?php endif; ?>
            </div>
    ...
    <div class="modal fade" id="uni_modal" role='dialog' data-bs-backdrop="static" data-bs-keyboard="true">
        ...
        <div class="modal-footer py-1">
            <button type="button" class="btn btn-sm rounded-0 btn-primary" id='submit' onclick="$('#uni_modal form').submit()">Sauvegarder</button>
