...
<div class="col-md-8 offset-2">
    <div class="card shadow-lg">
        <div class="card-header rounded-0">
            <div class="card-title">les informations de votre compte</div>
        </div>
        <div class="card-body">
            <form action="" class="" id="update-account">
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <label for="middlename" class="control-label">pseudo</label>
                ...
                <div class="form-group">
                    <label for="cpassword" class="control-label">Confirmer le mot de passe</label>
                ...
                <div class="form-group">
                    <label for="avatar" class="control-label">utiliser un avatar</label>
                ...
                <div class="form-group d-flex w-100 justify-content-end">
                    <button class="btn btn-sm btn-primary rounded-0 my-1">completer mes informations</button>
                </div>
            </form>
        </div>
    </div>
